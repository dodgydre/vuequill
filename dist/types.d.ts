...
type EditorChangeHandler = ((name: "text-change", delta: Delta, oldContents: Delta, source: Sources) => any) | ((name: "selection-change", range: RangeStatic, oldRange: RangeStatic, source: Sources) => any);
...
export type { Sources, TextChangeHandler, SelectionChangeHandler, EditorChangeHandler, DebugLevel, Module, Options, RangeStatic, Toolbar, ContentPropType };
